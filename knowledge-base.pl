...
itax(291550.01,inf,91435.02,35.00, monthly).
...
itax(67133.23,inf,21054.11,35.00,weekly).
...
itax(9590.47,inf,3007.73,35.00,daily).
...
itax(3498600.01,inf,1097220.21,35.00,yearly).
...
itax(143856.91,inf,45115.95,35.00, biweekly).
...
itax(95904.61,inf,30077.3,35, tenday).
